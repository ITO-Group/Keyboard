...
Java_com_example_zhoujianyu_keyboard_MainActivity_readDiffStart(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_zhoujianyu_keyboard_MainActivity_readDiffStop(JNIEnv *env, jobject instance) {
